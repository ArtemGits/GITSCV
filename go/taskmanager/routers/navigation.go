...
func SetNavigationRoutes(router *mux.Router) *mux.Router {
	...
	// subrouter := router.PathPrefix("/taskmanager/").Subrouter()
	 ...
	 router.HandleFunc("/taskmanager/createTask", controllers.TaskManagerCreateTask)
	 router.HandleFunc("/taskmanager/updateTask/{id}", controllers.TaskManagerUpdateTask)
	 router.HandleFunc("/taskmanager/updateNote/{id}", controllers.TaskManagerUpdateNote)
	 router.HandleFunc("/taskmanager/getTaskByUser", controllers.TaskManagerGetTaskByUser)
	 router.HandleFunc("/taskmanager/createNote", controllers.TaskManagerCreateNote)
